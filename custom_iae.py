# Custom iae by kajebiii
# See qiskit/algorithms/amplitude_estimators/iae.py
...
from qiskit.algorithms import AmplitudeEstimator, AmplitudeEstimatorResult, EstimationProblem, AlgorithmError


class CustomIterativeAmplitudeEstimation(AmplitudeEstimator):
